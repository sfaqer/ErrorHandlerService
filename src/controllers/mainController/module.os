...
Процедура pushReport() Экспорт
	...
	//  ЧтениеZipФайла падает при работе с архивами 1С, разберём через unzip
	//	ЗапуститьПриложение(СтрШаблон("unzip %1 -d %2", ВременныйФайлАрхив, ВременныйКаталог),, Истина); - Так работает
